...
addon_value ExportSession(addon_env env, addon_callback_info info) {
    try {
        ...
        TimelineExportFrameSetRequest frameSetRequest;
        frameSetRequest.outputDir = request.outputDir;
        frameSetRequest.aspectRatioMode = request.aspectRatioMode;
...
addon_value ExportSequence(addon_env env, addon_callback_info info) {
    try {
        ...
        SequenceExportFrameSetRequest frameSetRequest;
        frameSetRequest.framesDir = request.framesDir;
        frameSetRequest.aspectRatioMode = request.aspectRatioMode;
        frameSetRequest.maxWidth = request.maxWidth;
