...
- 更新提醒改为绘画计时行右侧的蓝色“可更新”入口，点击后可在弹窗中选择 GitHub 或网盘下载新版安装文件。
...
- Update reminders now use a blue "Update" entry at the right side of the painting-timer row. Clicking it opens a dialog with GitHub and netdisk download choices.
